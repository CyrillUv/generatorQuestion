...
export const dataQuest: IDataQuest[] = [{
  name: 'Структуры данных', questions: [
    {
      ...
      response: '1.В javascript в качестве списка выступает обычный массив.' +
      ...
      question:
        '  Кортежи',
      response: 'Кортежи (tuples) в TypeScript представляют собой особый вид массивов,' +
      ...
      response: 'В JavaScript у нас есть примитивные типы и ссылочные типы.' +
      ...
      question:
        'Понимание вычислительной сложности поиска и вставки данных',
      response: 'Number,string,boolean,object,null,undefined,Symbol,BigInt',
      active: false
    }, {
      question:
        'Совместимость структур данных и многопоточная обработка',
      response: 'Number,string,boolean,object,null,undefined,Symbol,BigInt',
      active: false
    }], active: false
},
  {
    name: 'JavaScript', questions: [
      ...
      {
        question: 'const, let, arrow fn, class, шаблонные строки, spread, rest, итератор, генератор ',
      ...
      {
        question: 'Два подхода к обработке событий в DOM(onevent,addEventListener).Пользовательские события.Стадии прохода события',
      ...
      {
        question: 'Web Worker ',
        response: 'aссинхронная система позволяет выполнять тяжелые в вычислительном плане и длительные задачи\n' +
      ...
      },
      {
        ...
        response: 'ООП в JS - наследование prototype,  у классов через new\n' +
      ...
      {
        question: 'Способы оптимизации работы с Dom.  Список самых дорогих операций',
      ...
      },
      {
        ...
        response: 'Модули - файл с use strict режимом, у них есть импорт и экспорт\n' +
