  ...
  questions: [
    ...
    },
    {
      ...
      response:
        ...
        '3. Наследование: Миксины могут наследовать другие миксины, что способствует уменьшению дублирования кода.',
      active: false,
    },
    {
      level: 'Junior',
    ...
    },
    {
      ...
      response:
        ...
        '- LESS: Переменные обозначаются с помощью @ а присваивается (:)' +
        '3. Миксины в SASS\n' +
        '\n' +
