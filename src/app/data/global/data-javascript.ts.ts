  ...
  questions: [
    ...
    },
    {
      ...
      response:
        ...
        '\n' +
        'Каждый объект в JavaScript имеет внутреннее свойство [[Prototype]], которое ссылается на другой объект (прототип). Это позволяет создавать цепочку объектов, называемую прототипной цепочкой.\n' +
        '\n' +
    ...
    },
    {
      ...
      response:
        ...
        'Использование: Часто используется в сочетании с библиотеками, такими как RequireJS.\n' +
        '\n' +
        '### 2. CommonJS\n' +
        '\n' +
    ...
    },
    {
      ...
      title: ' Web Worker ',
      response:
        ' Ассинхронная система позволяет выполнять тяжелые в вычислительном плане и длительные задачи\n' +
    ...
    },
    {
      ...
      response:
        ' Перебрать коллекцию HTML-элементов можно с помощью различных методов и подходов в JavaScript. Ниже приведены некоторые из наиболее распространенных способов:\n' +
        '\n' +
